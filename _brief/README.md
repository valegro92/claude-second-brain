...
| `07-naming-brand.md` | 14 candidati nome prodotto, shortlist 4 finalisti, raccomandazione finale ("Custodia") con razionale e checklist verifica pre-adozione. | Quando si decide il naming pubblico del prodotto, prima del primo sito/preventivo formale. |
